...
(function ($) {
    ...
    $.fn.fileinputLocales['id'] = {
        ...
        cancelLabel: 'Batal',
        cancelTitle: 'Batalkan proses impor',
        pauseLabel: 'Pause',
        pauseTitle: 'Pause ongoing upload',
        uploadLabel: 'Impor',
        uploadTitle: 'Impor berkas terpilih',
        msgNo: 'Tidak',
        msgNoFilesSelected: '',
        msgPaused: 'Paused',
        ...
        msgFileRequired: 'Anda harus memilih berkas untuk di-impor.',
        msgSizeTooSmall: 'Berkas "{name}" (<b>{size} KB</b>) terlalu kecil dan harus lebih besar dari <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'Berkas "{name}" (<b>{size} KB</b>) melebihi ukuran impor maksimal yaitu <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Anda harus memilih setidaknya <b>{n}</b> {files} untuk di-impor.',
        msgFilesTooMany: '<b>({n})</b> berkas yang dipilih untuk di-impor melebihi ukuran unggah maksimal yaitu <b>{m}</b>.',
        ...
        msgUploadAborted: 'Proses impor berkas dibatalkan',
        msgUploadThreshold: 'Memproses &hellip;',
        msgUploadBegin: 'Menyiapkan &hellip;',
        msgUploadEnd: 'Selesai',
        msgUploadResume: 'Resuming upload &hellip;',
        msgUploadEmpty: 'Tidak ada data valid yang tersedia untuk di-impor.',
        ...
        ajaxOperations: {
            ...
            uploadThumb: 'Impor berkas',
            uploadBatch: 'Impor banyak berkas',
            uploadExtra: 'Impor form ekstra'
        },
        ...
        fileActionSettings: {
            ...
            uploadTitle: 'Impor Berkas',
            uploadRetryTitle: 'Impor Ulang',
            downloadTitle: 'Unduh Berkas',
            zoomTitle: 'Tampilkan Rincian',
            dragTitle: 'Pindah atau Atur Ulang',
            indicatorNewTitle: 'Belum di-impor',
            indicatorSuccessTitle: 'Sudah di-impor',
            indicatorErrorTitle: 'Kesalahan dalam mengimpor',
            indicatorPausedTitle: 'Impor Paused',
            indicatorLoadingTitle:  'Mengimpor &hellip;'
        },
